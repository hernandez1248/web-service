...
describe("Registro de estado de una orden.", () => {
    ...
    it("Debe rechazar registro de un nuevo estado de la orden sin fecha", (done) => {
        chai.request(url)
        .post('/states')
        .send({
            ordersId: 1,  
    ...
    it("Debe rechazar registro de un nuevo estado de la orden con fecha inválida", (done) => {
        chai.request(url)
        .post('/states')
        .send({
            ordersId: 1, 
...
describe("Actualizar estado de la orden.", () => {
    ...
    it("Debe rechazar la actualización de un estado de orden con fecha inválida", (done) => {
        chai.request(url)
        .patch('/states')
        .send({
            id: 4,
