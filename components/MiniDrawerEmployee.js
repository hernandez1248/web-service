...
export default function MiniDrawerEmployee({children}) {
  ...
  const handleOrdersClick = () => {
    router.push("/ordersEmployee")
  }

  const handleDevicesClick = () => {
    router.push("/devicesEmployee")
  }
  const handleComponentsClick = () => {
    router.push("/componentsEmployee")
  }
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <Divider />
        <List>
          {["Inicio", "Ordenes", "Dispositivos", "Componentes"].map(
            (text, index) => (
